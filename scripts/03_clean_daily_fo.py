...
def clean_latest_zip():
    ...
    if df is None:
        print("⚠️ Instrument-level futures table not found (summary-only file)")
        print("⏭️ Skipping FO clean for this date")
        return
    ...
    if df.empty:
        print("⚠️ Futures table found but no FUTIDX/FUTSTK rows")
        return
